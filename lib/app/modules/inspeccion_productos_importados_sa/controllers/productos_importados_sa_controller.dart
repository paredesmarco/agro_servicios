...
class ProductosImportadosSaController extends GetxController
    ...
    if (res.estado == 'exito') {
      ...
      if (lista.isNotEmpty) {
        try {
          ...
          mensajeRespuesta =
              'Se sincronizaron los registros de DDA de Sanidad Animal';
  ...
  subirDatos(
    ...
    if (cantidadInspecciones.value > 0) {
      ...
      // mensajeGuardado.value = SINCRONIZANDO_UP;
      ...
      mensajeGuardado.value = SIN_REGISTROS;
      tiempo = 4;
      estadoSincronizacion = 'advertencia';
