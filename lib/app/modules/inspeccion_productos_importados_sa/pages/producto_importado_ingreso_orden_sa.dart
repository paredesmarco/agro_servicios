...
class ProductoImportadoIngresOrdenSa extends StatelessWidget {
  const ProductoImportadoIngresOrdenSa({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return CuerpoFormularioIngreso(
      ...
      botonFormulario: BotonPlano(
          ...
          funcion: () async {
            bool esValido = Get.find<ProductosImportadosOrdenSaController>()
                .validarFormulario();
            if (esValido) {
              Get.find<ProductosImportadosOrdenSaController>()
                  .guardarFormulario(
                      titulo: ALMACENANDO,
...
class _Producto extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return GetBuilder<ProductosImportadosOrdenSaController>(
      id: 'idValidacion',
      builder: (_) {
        return Combo(
...
class _CodigoMuestra extends GetView<ProductosImportadosOrdenSaController> {
...
class _Entomologico01 extends GetView<ProductosImportadosOrdenSaController> {
...
class _Entomologico02 extends GetView<ProductosImportadosOrdenSaController> {
...
class _Nematodos01 extends GetView<ProductosImportadosOrdenSaController> {
...
class _Nematodos02 extends GetView<ProductosImportadosOrdenSaController> {
...
class _Nematodos03 extends GetView<ProductosImportadosOrdenSaController> {
...
class _Nematodos04 extends GetView<ProductosImportadosOrdenSaController> {
...
class _Nematodos05 extends GetView<ProductosImportadosOrdenSaController> {
...
class _Nematodos06 extends GetView<ProductosImportadosOrdenSaController> {
...
class _Nematodos07 extends GetView<ProductosImportadosOrdenSaController> {
...
class _Nematodos08 extends GetView<ProductosImportadosOrdenSaController> {
...
class _Nematodos09 extends GetView<ProductosImportadosOrdenSaController> {
...
class _Fitopatologico01 extends GetView<ProductosImportadosOrdenSaController> {
...
class _Fitopatologico02 extends GetView<ProductosImportadosOrdenSaController> {
...
class _Fitopatologico03 extends GetView<ProductosImportadosOrdenSaController> {
...
class _Fitopatologico04 extends GetView<ProductosImportadosOrdenSaController> {
...
class _Fitopatologico05 extends GetView<ProductosImportadosOrdenSaController> {
...
class _Fitopatologico06 extends GetView<ProductosImportadosOrdenSaController> {
...
class _Fitopatologico07 extends GetView<ProductosImportadosOrdenSaController> {
...
class _Fitopatologico08 extends GetView<ProductosImportadosOrdenSaController> {
...
class _ErrorAnalisis extends GetView<ProductosImportadosOrdenSaController> {
...
class _MensajeModal extends GetView<ProductosImportadosOrdenSaController> {
...
class _IconoModal extends GetView<ProductosImportadosOrdenSaController> {
