...
class ProductoImportadoIngresoLoteSa extends StatelessWidget {
  const ProductoImportadoIngresoLoteSa({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return CuerpoFormularioIngreso(
      ...
      botonFormulario: BotonPlano(
          ...
          funcion: () async {
            bool esValido = Get.find<ProductosImportadosLotesSaController>()
                .validarFormulario();
            if (esValido) {
              Get.find<ProductosImportadosLotesSaController>()
                  .guardarFormulario(
                titulo: ALMACENANDO,
...
class _DescripcionLote extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return GetBuilder<ProductosImportadosLotesSaController>(
      id: 'idValidacion',
      builder: (_) {
        return CampoTexto(
          maxLength: 512,
...
class _CajasMuestra extends GetView<ProductosImportadosLotesSaController> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        GetBuilder<ProductosImportadosLotesSaController>(
          id: 'idAusenciaSuelo',
          builder: (_) {
            return Row(
              children: [
...
class _AusenciaContaminantes extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        const CampoDescripcion(
          etiqueta: 'Ausencia de contaminantes pecuarios prohibidos',
        ),
        GetBuilder<ProductosImportadosLotesSaController>(
...
class _MensajeModal extends GetView<ProductosImportadosLotesSaController> {
...
class _IconoModal extends GetView<ProductosImportadosLotesSaController> {
