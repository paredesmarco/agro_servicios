...
class ProductosImportadosSeleccionRegistrolSa
    extends GetView<SeleccionRegistroProductosImportadosSaController> {
  const ProductosImportadosSeleccionRegistrolSa({Key? key}) : super(key: key);
              ...
              return TarjetaRegistros(
                onTap: () async {
                  ...
                  if (esLlenado) {
                    ...
                    Get.toNamed(Rutas.PRODUCTOSIMPORTADOSNUEVOSA);
                  }
                },
