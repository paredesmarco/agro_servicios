...
class MinadorPaso3Controller extends GetxController
  ...
  final controladorP1 = Get.find<MinadorPaso1Controller>();
  ...
  setestadoF08(valor) {
    controlador.modelo.estadoF08 = valor;
    controlador.actualizarCampo('estado_f08', valor);
  }
  ...
  guardarMinadorDatos(
    ...
    if (validaDatosP3 && controladorP1.validaDatosFormulario) {
      ...
      // List<MinadorSitioModelo> _lista = await controlador.listaAreasSeleccionadas(
  ...
  Future<void> establecerResultado() async {
    ...
    listaPonderacionModelo =
        await minadorRepositorio.getPonderacionParaFormulario(
