...
class MinadorPaso1Controller extends GetxController
  ...
  List<MinadorSitioModelo> listaAreasSelecionadas = [];
  List<MinadorSitioModelo> listaSitios = [];
  List<MinadorSitioModelo> listaTipoAreas = [];
  List<MinadorSitioModelo> listaAreas = [];
  ...
  Future<void> getListaOperador() async {
    ...
    List<MinadorProductorModelo> poderes = await controlador.listaOperador();
  ...
  Future<void> getListaTipoArea(idsitio) async {
    ...
    MinadorSitioModelo? modeloSitio = await controlador.modeloSitio(idsitio);
  ...
  Future<void> getListaArea(tipo) async {
    ...
    final controllerP2 = Get.find<MinadorPaso2Controller>();
  ...
  Future<void> getBuscarUbicacionAreas(listAreaSelect) async {
    ...
    String areas = cadena;
    List<MinadorSitioModelo> lista = await controlador.listaAreasSeleccionadas(
  ...
  limpiarDatos(tipo) {
    switch (tipo) {
      ...
      case 'Area':
        ...
        listaAreasSelecionadas = [];
        listaAreas = [];
        controlador.modelo.observacionF08 = null;
        errorArea = null;
        break;
  ...
  ///Inicializa el modelo con datos basicos en estado Incompleto y campos vacios
  cargarModelo() async {
    if (controlador.modelo.estadoF08 == 'En proceso...') {
  ...
  modeloNuevo() async {
    ...
    controlador.modelo.estadoF08 = "En proceso...";
    controlador.modelo.observacionF08 = '';
