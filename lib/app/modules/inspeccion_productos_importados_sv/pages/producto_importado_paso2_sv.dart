...
class ProductoImportadoPaso2Sv extends StatelessWidget {
  const ProductoImportadoPaso2Sv({Key? key}) : super(key: key);
...
class _Lotes extends GetView<ProductosImportadosPaso2SvController> {
