...
class ProductoImportadoPaso4Sv extends StatefulWidget {
  const ProductoImportadoPaso4Sv({Key? key}) : super(key: key);

  @override
  State<ProductoImportadoPaso4Sv> createState() =>
      _ProductoImportadoPaso4SvState();
}

class _ProductoImportadoPaso4SvState extends State<ProductoImportadoPaso4Sv>
...
class _ErrorCantidadIngresada extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return GetBuilder<ProductosImportadosPaso4SvController>(
...
class _Tabla extends GetView<ProductosImportadosPaso4SvController> {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: GetBuilder<ProductosImportadosPaso4SvController>(
        builder: (_) {
          return DataTable(
            sortAscending: false,
            columns: const [
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        GetBuilder<ProductosImportadosPaso4SvController>(
          id: 'idSeguimiento',
          builder: (_) {
            return Row(
              children: [
...
class _Observaciones extends GetView<ProductosImportadosPaso4SvController> {
