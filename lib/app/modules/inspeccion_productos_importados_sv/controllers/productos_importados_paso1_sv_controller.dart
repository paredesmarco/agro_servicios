...
class ProductosImportadosPaso1SvController extends GetxController
  ...
  bool validarFormulario() {
    ...
    if (marcaAutorizada == null || marcaAutorizada == '') {
      esValido = false;
      errorPregunta03 = true;
    } else {
      errorPregunta03 = false;
    }

    if (marcaLegible == null || marcaLegible == '') {
      esValido = false;
      errorPregunta04 = true;
    } else {
      errorPregunta04 = false;
    }

    if (danioInsecto == null || danioInsecto == '') {
      esValido = false;
      errorPregunta05 = true;
    } else {
      errorPregunta05 = false;
    }

    if (insectosVivos == null || insectosVivos == '') {
      esValido = false;
      errorPregunta06 = true;
    } else {
      errorPregunta06 = false;
    }

    if (corteza == null || corteza == '') {
      esValido = false;
      errorPregunta07 = true;
    } else {
      errorPregunta07 = false;
    }

    if (empaques == null || empaques == '') {
      esValido = false;
      errorPregunta08 = true;
    } else {
      errorPregunta08 = false;
    }
    ...
    if (_controlador.inspeccion.numeroEmbalajesEnvio == null) {
      esValido = false;
      errorNumeroEmbalajeEnvio = CAMPO_REQUERIDO;
    } else {
      errorNumeroEmbalajeEnvio = null;
    }

    if (_controlador.inspeccion.numeroEmbalajesInspeccionados == null) {
      esValido = false;
      errorNumeroEmbalajeInspeccion = CAMPO_REQUERIDO;
    } else {
      errorNumeroEmbalajeInspeccion = null;
    }
